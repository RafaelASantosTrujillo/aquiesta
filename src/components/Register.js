            ...
            <div className="pt-5 container-fluid d-flex justify-content-center">
                <form>
                    <div className="mb-3">
                        <div className="row g-3 d-flex flex-row align-items-center">
                            <div className="col-auto">
                                <label for="nameRegister" class="col-form-label" required>Nombre</label>
                            </div>
                            <div className="col-auto">
                                <input type="text" className="form-control" />
                            </div>
                            <div className="col-auto">
                                <label for="lastNameRegister" class="col-form-label" required>Apellido</label>
                            </div>
                            <div className="col-auto">
                                <input type="text" className="form-control" />
                            </div>
                    ...
                    <div className="mb-3">
                        <div className="row g-3 d-flex flex-row align-items-center">
                            <div className="col-auto">
                                <label for="genderRegister" class="col-form-label">Genero</label>
                            </div>
                            <div className="col-auto">
                            ...
                            <div className="col-auto">
                                <label for="stateRegister" class="col-form-label">¿En qué estado vives?</label>
                            </div>
                            <div className="col-auto">
                                <div className="col-auto">
                                    <select className="form-select" required>
                    ...
                    <div className="mb-3">
                        <div className="form-check">
                            <div className="form-check form-switch">
                                ...
                                <label className="form-check-label" for="flexSwitchCheckDefault">Soy dueño de un negocio</label>
                            </div>
                        </div>
                    </div>
